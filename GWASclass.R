...
results<-read.csv("GAPIT.Association.GWAS_Results.MLM.EarHT.csv", header = T)
head(results)

manhattan(results, main="Ear height", chr = "Chr", bp = "Pos", p = "P.value", snp = "SNP",           
	      col = c("purple", "green"),           
	      genomewideline = 3.5,  highlight = "PZA03188.4"  )

png("customized_manhattan_plot.png", width = 8, height = 4, units = "in", res = 300 )
